...
export default function Page() {
  ...
  useEffect(() => { fetchApplications().then(setAllData).catch(console.error); }, []);
  ...
  const underReview = allData.filter((a) => a.status === "under_review").length;
    ...
    <div className="container mx-auto py-10 space-y-4">
      ...
      <div className="grid grid-cols-5 gap-3">
        {[
          ...
          { label: "Submitted",    value: submitted,      className: "text-blue-600"     },
          { label: "Under Review", value: underReview,    className: "text-yellow-600"   },
          { label: "Approved",     value: approved,       className: "text-green-600"    },
